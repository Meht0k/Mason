    ...
    <>
      <div className="container-fluid px-0 py-5" id="Women">
        <div className='row border-black border border-opacity-25 mt-5'>
          <div className='col-1 d-flex align-items-center justify-content-center pt-3 pb-2 border-end border-black border-opacity-25'>
          ...
          <div className='col-9 border-end border-secondary border-opacity-25 pt-3 pb-2'>
            <p className='text-secondary text-center' style={{ fontSize: ".9rem" }}>{womenProduct.length} Products</p>
          </div>
          <div className='col-1 text-center pt-3 pb-2 border-end border-secondary border-opacity-25'>
            <div class="dropdown">
        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-4 py-5 px-1 px-md-3 px-lg-5 g-1">
          {womenProduct.map((cards, index) => {
            return (
              <div className='col'>
                <div class="card border-0 rounded-0 women-card" key={index}>
